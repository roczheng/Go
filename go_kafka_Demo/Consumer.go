...
var (
	brokerList = flag.String("brokers", "10.0.245.3:9092", "The comma separated list of brokers in the Kafka cluster")
	topic      = flag.String("topic", "Test", "The topic to consume")
